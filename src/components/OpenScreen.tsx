      ...
      <div className='min-h-full flex flex-col justify-center items-center px-4 py-8'>
        ...
        <div className='flex flex-col justify-center items-center gap-4 sm:gap-6 max-w-2xl w-full'>
          ...
          <div className='flex flex-col items-center gap-3 text-center'>
            <h1 className='text-[#3D08BA] text-[30px] font-bold leading-tight'>
              Transform Your Learning Journey
            </h1>
            <div className='flex flex-col items-center gap-2'>
              <p className='text-[#3D08BA] text-[14px] font-medium leading-relaxed opacity-80 max-w-sm'>
          ...
          <div className='grid grid-cols-2 gap-4 sm:gap-6 w-full'>
            <div className='bg-white border-2 border-[#3D08BA]/20 rounded-xl p-6 sm:p-8 flex flex-col items-center gap-3 shadow-sm hover:shadow-md transition-shadow'>
              ...
              <p className='text-[#3D08BA] text-[14px] font-semibold text-center'>Study Resources</p>
            </div>
            ...
            <div className='bg-white border-2 border-[#3D08BA]/20 rounded-xl p-6 sm:p-8 flex flex-col items-center gap-3 shadow-sm hover:shadow-md transition-shadow'>
              ...
              <p className='text-[#3D08BA] text-[14px] font-semibold text-center'>Peer Learning</p>
            </div>
            ...
            <div className='bg-white border-2 border-[#3D08BA]/20 rounded-xl p-6 sm:p-8 flex flex-col items-center gap-3 shadow-sm hover:shadow-md transition-shadow'>
              ...
              <p className='text-[#3D08BA] text-[14px] font-semibold text-center'>Virtual Classes</p>
            </div>
            ...
            <div className='bg-white border-2 border-[#3D08BA]/20 rounded-xl p-6 sm:p-8 flex flex-col items-center gap-3 shadow-sm hover:shadow-md transition-shadow'>
              ...
              <p className='text-[#3D08BA] text-[14px] font-semibold text-center'>Expert Teachers</p>
            </div>
          </div>

          {/* CTA Text */}
          <p className='text-[#3D08BA] text-[14px] font-medium opacity-70'>
            Join thousands of students learning better
          </p>

          {/* Next Button */}
          <button onClick={handleNext} className='bg-[#3D08BA] hover:bg-[#F68C29] flex items-center justify-center transition-colors rounded-lg px-8 py-3 text-white text-[14px] font-semibold shadow-lg w-full sm:w-auto'>
            Next
          </button>
        </div>
      </div>
